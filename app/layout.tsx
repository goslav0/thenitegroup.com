...
export default function RootLayout({
  ...
  return (
    <html lang="pl">
      <head>
        {/* ZMIANA: Strategia na lazyOnload, aby nie blokować renderowania 3D i animacji */}
        <Script id="posthog-init" strategy="lazyOnload">
          {`
            ...
            posthog.init('phc_t7ykpk4saxTGtF2fuHakuALuhszs8EhTF2xfSkCOrir', {
              api_host: 'https://eu.i.posthog.com', 
              person_profiles: 'always',
              capture_pageview: true,
              // DODATKOWA OPTYMALIZACJA:
              autocapture: false, // Wyłączamy automatyczne śledzenie każdego kliknięcia (zżera CPU)
              disable_session_recording: false, // Jeśli nie musisz widzieć nagrań wideo z sesji, daj 'true' dla max wydajności
            })
          `}
        </Script>
      </head>
